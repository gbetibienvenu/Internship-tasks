...
//import com.example.ambulanceserviceprovider.model.AmbulanceStatus;
...
public class AmbulanceService {
    ...
    @Autowired
    public AmbulanceService(RequestRepository requestRepository, AmbulanceRepository ambulanceRepository) {
    ...
    public Ambulance updateAmbulance(Long id, Ambulance updatedAmbulance) {
        ...
        if (updatedAmbulance.getLocation() != null) {
            ambulance.setLocation(updatedAmbulance.getLocation());
        }
        if (updatedAmbulance.getModel() != null) {
            ambulance.setModel(updatedAmbulance.getModel());
        }
        return ambulanceRepository.save(ambulance);
    }
